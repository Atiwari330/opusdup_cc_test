# Test SOAP analysis on uploaded transcript
param(
    [string]$TranscriptId = "d4b24576-3d9b-4bd0-959b-ca6b148263a9"
)

Write-Host "Testing SOAP Analysis" -ForegroundColor Green
...
try {
    ...
    Write-Host "Starting SOAP analysis..." -ForegroundColor Yellow
